...
$netWeightOuter = $labelCollection->collection[0]->inners[0]->net_weight;
...
$totalInnerOuter = $labelCollection->collection[0]->totalInner;
...
$outerPackage = [
    ...
    "netWeight" => $netWeightOuter,
    "totalInner" => $totalInnerOuter,
